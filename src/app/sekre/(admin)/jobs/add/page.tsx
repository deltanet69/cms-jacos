...
export default function AddJobVacancy() {
    ...
    useEffect(() => {
        const checkUser = async () => {
            try { await account.get(); } catch (err) { console.error("User not logged in", err); }
        };
        checkUser();
    }, []);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await databases.createDocument(DATABASE_ID, TABLE_JOBS, ID.unique(), jobData);

            // Redirect immediately. The listing page fetches data on mount anyway.
    ...
    return (
        <>
            <Breadcrumb pageName="Add Job Vacancy" />
                        ...
                        <div className="p-6.5">
                            <div className="bg-white dark:bg-form-input">
                                <ReactQuill
                                    ...
                                    placeholder="Write the full job description, core requirements, and required documents here..."
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="md:col-span-4 flex flex-col gap-9">
                    ...
                    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        ...
                        <div className="p-6.5">
                            ...
                            >
                                {loading ? <Loader2 className="animate-spin" size={20} /> : "Publish Job Vacancy"}
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <style jsx global>{`
                ...
                .ql-editor.ql-blank::before { font-size: 16px; }
